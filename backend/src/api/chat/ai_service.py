...
messages = [
        ...
        ("human", "Do not use markdown in your response only plaintext"),
    ]

# llm_base.invoke("Tell me about youself.")

response = llm_base.invoke("What do you know about python programming language application?")
